...
public:
  ...
  static std::vector<float> test_prop;
  static float test_max_size;
  static float test_nms;
  static float test_iou_thresh;
  static vector<float> test_max_occlusion;
  static vector<float> test_min_area;
  ...
  static bool bounding_box_vote;
  static float bounding_box_vote_thresh;
  static int bbox_vote_n_weighted_score;
  static float bbox_vote_weight_empty;
  ...
  static std::vector<float> anchor_ratios;
  static std::vector<float> anchor_scales;
  static float test_score_thresh;
  static int iter_test;
  static int scale_multiple_of;

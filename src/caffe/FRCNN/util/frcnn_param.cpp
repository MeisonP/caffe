...
std::vector<float> FrcnnParam::test_prop;
float FrcnnParam::test_max_size;
float FrcnnParam::test_nms;
float FrcnnParam::test_iou_thresh;
vector<float> FrcnnParam::test_max_occlusion;
vector<float> FrcnnParam::test_min_area;
...
bool FrcnnParam::bounding_box_vote;
float FrcnnParam::bounding_box_vote_thresh;
int FrcnnParam::bbox_vote_n_weighted_score;
float FrcnnParam::bbox_vote_weight_empty;
...
std::vector<float> FrcnnParam::anchor_ratios;
std::vector<float> FrcnnParam::anchor_scales;
float FrcnnParam::test_score_thresh;
int FrcnnParam::n_classes;
int FrcnnParam::iter_test;
// ======================================== 
int FrcnnParam::scale_multiple_of;
...
void FrcnnParam::load_param(const std::string default_config_path) {
  ...
  FrcnnParam::test_prop = extract_vector("test_prop", default_map);
  FrcnnParam::test_max_size = extract_float("test_max_size", default_map);
  FrcnnParam::test_nms = extract_float("test_nms", default_map);
  FrcnnParam::test_iou_thresh = extract_float("test_iou_thresh", default_map);
  FrcnnParam::test_max_occlusion = extract_vector("test_max_occlusion", default_map);
  FrcnnParam::test_min_area = extract_vector("test_min_area", default_map);
  ...
  FrcnnParam::bounding_box_vote = extract_int("bounding_box_vote", default_map);
  FrcnnParam::bounding_box_vote_thresh = extract_float("bounding_box_vote_thresh", default_map);
  FrcnnParam::bounding_box_vote_thresh = extract_int("bbox_vote_n_weighted_score", default_map);
  FrcnnParam::bounding_box_vote_thresh = extract_float("bbox_vote_weight_empty", default_map);
  ...
  FrcnnParam::anchor_ratios = extract_vector("anchor_ratios", default_map);
  FrcnnParam::anchor_scales = extract_vector("anchor_scales", default_map);
  ...
  // pva
  FrcnnParam::scale_multiple_of = extract_int("scale_multiple_of", default_map);

  n_classes = caffe::Frcnn::LoadVocClass().size();
...
void FrcnnParam::print_param(){
  ...
  LOG(INFO) << "test_prop          : " << float_to_string(FrcnnParam::test_prop); 
  LOG(INFO) << "test_max_size        : " << FrcnnParam::test_max_size; 
  LOG(INFO) << "test_nms             : " << FrcnnParam::test_nms; 
  LOG(INFO) << "test_iou_thresh             : " << FrcnnParam::test_iou_thresh; 
  ...
  LOG(INFO) << "bounding_box_vote   : " << FrcnnParam::bounding_box_vote; 
  LOG(INFO) << "bounding_box_vote_thresh   : " << FrcnnParam::bounding_box_vote_thresh; 
  LOG(INFO) << "bbox_vote_n_weighted_score: " << FrcnnParam::bbox_vote_n_weighted_score;
  LOG(INFO) << "bbox_vote_weight_empty: " << FrcnnParam::bbox_vote_weight_empty;
  ...
  LOG(INFO) << "scale_multiple_of: " << FrcnnParam::scale_multiple_of;
}

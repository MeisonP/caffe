...
def write_prototxt(is_train, source, output_folder, to_seperable=False):
    ...
    n.concat_convf_silence = L.Silence(concat_convf, name="concat_convf_silence", ntop = 0)

    anchor_num = 25


    #  # train rpn
    n['rpn_conv1'] = rpn_conv1 = L.Convolution(convf_rpn, param=[dict(lr_mult=1.0, decay_mult=1.0), dict(lr_mult=2.0, decay_mult=0)], convolution_param=dict(pad=1, stride=1 , kernel_size=3, num_output=384, weight_filler=dict(type='gaussian', std=0.01), bias_filler=dict(type='constant', value=0)))
    ...
    # silence
    n.silence_fc7 = L.Silence(fc7, ntop=0)
...
if __name__ == '__main__':
    ...
    filepath = './stage2_rpn_train.prototxt'

...
vocabulary = ['<EOS>'] + [line.strip() for line in open('examples/coco_caption/h5_data/buffer_100/vocabulary.txt').readlines()]
...
#  third_word_dist = predict_single_word(net, vocabulary.index('leaves'))
#  print [vocabulary[index] for index in np.argsort(-1 * second_word_dist)[:10]]
